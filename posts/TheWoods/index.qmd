...
<details>
  ...
  Most folks are probably familiar with panning and zooming on a slippy map like this. This map has a few less widely used features, though, primarily to interface the 3D effects. 
